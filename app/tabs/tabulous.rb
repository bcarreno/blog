...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------#
      [    :sandbox_tab       ,    'Sandbox'       ,    sandbox_path       ,    true        ,    true        ],
      [    :users_tab         ,    'Users'         ,    users_path         ,    true        ,    true        ],
      [    :pages_tab         ,    'Pages'         ,    pages_path         ,    true        ,    true        ],
      [    :categories_tab    ,    'Categories'    ,    categories_path    ,    true        ,    true        ],
      [    :articles_tab      ,    'Home'          ,    root_path          ,    true        ,    true        ],
      #------------------------------------------------------------------------------------------------------#
      #    TAB NAME           |    DISPLAY TEXT    |    PATH               |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #----------------------------------------------------------------#
      [    :sandbox       ,    :all_actions    ,    :sandbox_tab       ],
